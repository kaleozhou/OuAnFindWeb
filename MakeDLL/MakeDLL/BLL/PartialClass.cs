...
//       {
//           MODEL.FindUsers model = GetSingleModelBy(s => s. == _username && s.VisitorStatus == true);
//           if(model==null)
//           {
...
//           }
//       }
//        public MODEL.FindUsers GetLoginInfo()
//       {
//           int _userID = CookieHelper.GetCookieValue("VisitorId").ToInt();
//           MODEL.FindUsers model = GetSingleModelBy(s => s.VisitorId == _userID);
//           return model;
//       }
