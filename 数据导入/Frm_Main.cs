...
namespace 数据导入
{
    public partial class Frm_Main : Form
    {
        ...
        public Frm_Main()
        {
            ...
            ConnectData.StaticServerIP = "127.0.0.1";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
	            ...
	            {	 
                    ...
                    model.UserName = model.SupplierId.ToString();//供应商编号为用户名
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < dt.Rows.Count; i++)
            {
                ...
                if (DB.I_RetailSales.GetSingleModelBy(s=>s.StoreNumber==model.StoreNumber)==null)
                {
                    ...
                    if (bankRow != null)
                    {
                        model.BankName = bankRow["bank_name"].ToString();//银行
                        model.FullName = bankRow["bank_branch"].ToString();//开户行
                        model.BankAccount = bankRow["bank_card"].ToString().Replace(" ", "").Replace("　", "");//卡号
                    }
